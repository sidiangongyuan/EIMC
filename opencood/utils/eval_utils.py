...
def eval_final_results_more_metric(result_stat, save_path, noise_level=None):
    dump_dict = {}

    ap_30, mrec_30, mpre_30 = calculate_ap(result_stat, 0.30)
    ap_50, mrec_50, mpre_50 = calculate_ap(result_stat, 0.50)
    ap_70, mrec_70, mpre_70 = calculate_ap(result_stat, 0.70)
    ap_75, mrec_75, mpre_75 = calculate_ap(result_stat, 0.75)
    ap_80, mrec_80, mpre_80 = calculate_ap(result_stat, 0.80)
    ap_85, mrec_85, mpre_85 = calculate_ap(result_stat, 0.85)
    ap_90, mrec_90, mpre_90 = calculate_ap(result_stat, 0.90)
    ap_95, mrec_95, mpre_95 = calculate_ap(result_stat, 0.95)
    ...
    if noise_level is None:
        yaml_utils.save_yaml(dump_dict, os.path.join(save_path, 'moreap_eval.yaml'))
    else:
    ...
    print('The Average Precision at IOU 0.3 is %.4f, '
          ...
          'The Average Precision at IOU 0.7 is %.4f, '
          'The Average Precision at IOU 0.75 is %.4f, '
          'The Average Precision at IOU 0.8 is %.4f, '
          'The Average Precision at IOU 0.85 is %.4f, '
                    'The Average Precision at IOU 0.90 is %.4f, '
                              'The Average Precision at IOU 0.95 is %.4f'
        
                 % (ap_30, ap_50, ap_70 , ap_75, ap_80, ap_85, ap_90, ap_95))

    return ap_30, ap_50, ap_70, ap_80, ap_85, ap_90, ap_95