...
from opencood.data_utils.datasets.TUMV2X_intermediate_fusion_dataset import TUMV2XIntermediateFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert dataset_name in ['opv2v', 'v2xsim', 'dairv2x', 'v2xset', 'tumv2x']

    if dataset_name == 'tumv2x':
        dataset = TUMV2XIntermediateFusionDataset(        
            params=dataset_cfg,
        visualize=visualize,
        train=train
        )
