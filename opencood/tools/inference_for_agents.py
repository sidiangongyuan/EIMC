...
def test_parser():
    ...
    parser.add_argument('--model_dir', type=str,
                        help='Continued training path', default='/mnt/sdb/public/data/yangk/result/heal/opv2v_attn_2024_12_19_17_11_29')
...
def main():
    ...
    AP50 = []
    AP70 = []
    for agent_num in agents_num:
        if agent_num == 4:
            continue
        hypes['train_params']['max_cav'] = agent_num
        if  'cobevt' in hypes['model']['args']:
            hypes['model']['args']['cobevt']['agent_size'] = agent_num
        # setting noise
        np.random.seed(303)
        ...
        infer_info = opt.fusion_method + opt.note + f'_{agent_num}'
        ...
        yaml_utils.save_yaml(dump_dict, os.path.join(opt.model_dir, f'AP030507.yaml'))
