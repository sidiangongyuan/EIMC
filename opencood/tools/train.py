...
def train_parser():
    ...
    #                     help='data generation yaml file needed ', default='/home/yangk/HEAL/opencood/hypes_yaml/dairv2x/MM/QumCo.yaml')
    # parser.add_argument("--hypes_yaml", "-y", type=str,
    #                     help='data generation yaml file needed ', default='/home/yangk/HEAL/opencood/hypes_yaml/opv2v/MM/bm2cp.yaml')
    parser.add_argument("--hypes_yaml", "-y", type=str,
                        help='data generation yaml file needed ', default='/home/yangk/HEAL/opencood/hypes_yaml/dairv2x/MM/DSfusion_V2_Lonly.yaml')
